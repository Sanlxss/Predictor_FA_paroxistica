...
#args = parser.parse_args(['--load', '28252', '--niters', '100', '-n', '11636', '-l', '20', '--dataset', 'fibrillation', '--latent-ode', '--rec-dims', '40', '--rec-layers', '3', '--gen-layers', '3', '--units', '50', '--gru-units', '50', '--classif', '--classif_tipe_multiclass'])
args = parser.parse_args(['--niters', '100', '-n', '11636', '-l', '20', '-b', '100', '--dataset', 'fibrillation', '--latent-ode', '--rec-dims', '40', '--rec-layers', '3', '--gen-layers', '3', '--units', '50', '--gru-units', '50', '--classif', '--classif_tipe_multiclass'])
...
if __name__ == '__main__':
	...
	if args.load is not None:
		...
		if args.classif_tipe_multiclass:
			x = np.array(batch_dict['labels']) #guardamos valores reales
			y = train_res['label_predictions'] #guardamos prediciones
